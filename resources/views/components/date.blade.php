<div class="date-picker max-w-md w-full shadow-own">
    <div class="md:p-8 p-5 bg-white rounded-lg space-y-8">
        <div class="px-4 flex items-center justify-between">
            <span  tabindex="0" class="focus:outline-none  text-base font-bold text-gray-600">October 2020</span>
                        ...
                        <td>
                            <div class="w-full h-full">
                                <div class="flex items-center justify-center w-full rounded-full cursor-pointer">
                                    <a  role="link" tabindex="0" class="focus:outline-none  focus:ring-2 focus:ring-offset-2 focus:ring-blue-700 focus:bg-blue-500 hover:bg-blue-500 text-base w-8 h-8 flex items-center justify-center font-medium text-white bg-blue-700 rounded-full">8</a>
                                </div>
                            </div>
                        </td>
                        <td>
